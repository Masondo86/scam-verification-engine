...
export default function ScamPsychologyPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 bg-white">
      ...
      {/* Introduction */}
      <h2 className="text-2xl font-bold mb-4 text-slate-900">Why Scams Work</h2>
      ...
      <h2 className="text-2xl font-bold mb-4 text-slate-900">🛡️ How to Build Psychological Resistance</h2>
