...
export default function WhatsAppScamsPage() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 bg-white">
      ...
      {/* Why WhatsApp */}
      <section className="bg-slate-50 rounded-xl p-8 mb-8 border border-slate-100">
        <h2 className="text-2xl font-bold text-slate-900 mb-4">Why Scammers Love WhatsApp</h2>
        <p className="text-slate-600 mb-4">
          With over <strong className="text-indigo-600">90% of South Africans</strong> using WhatsApp, 
          it's become the primary hunting ground for scammers. The platform's features make it perfect for fraud:
        </p>
        <div className="grid md:grid-cols-2 gap-4 mt-6">
          <div className="bg-red-50 border border-red-200 rounded p-4">
            <div className="text-red-700 font-bold mb-2">✗ End-to-end encryption</div>
            <p className="text-slate-600 text-sm">Makes it harder for WhatsApp to detect scams</p>
          </div>
          <div className="bg-red-50 border border-red-200 rounded p-4">
            <div className="text-red-700 font-bold mb-2">✗ Easy to spoof numbers</div>
            <p className="text-slate-600 text-sm">Scammers can fake contact names and profiles</p>
          </div>
          <div className="bg-red-50 border border-red-200 rounded p-4">
            <div className="text-red-700 font-bold mb-2">✗ Instant reach</div>
            <p className="text-slate-600 text-sm">One message reaches thousands immediately</p>
          </div>
          <div className="bg-red-50 border border-red-200 rounded p-4">
            <div className="text-red-700 font-bold mb-2">✗ Trusted platform</div>
            <p className="text-slate-600 text-sm">People assume messages are from real contacts</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-slate-900 mb-6">Top 10 WhatsApp Scams in SA</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-red-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-red-50 flex items-center justify-center text-red-600 font-bold text-xl">
                1
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Account Hijacking</h3>
                <p className="text-slate-600 text-sm">The most dangerous scam</p>
              </div>
            </div>
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">How it works:</strong> Scammer tries to register your number on a new device. 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-orange-50 flex items-center justify-center text-orange-600 font-bold text-xl">
                2
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Impersonation Scam</h3>
                <p className="text-slate-600 text-sm">"Mom, I lost my phone..."</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">How it works:</strong> Using a hijacked account or new number, 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-yellow-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-yellow-50 flex items-center justify-center text-yellow-600 font-bold text-xl">
                3
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Fake Job Offers</h3>
                <p className="text-slate-600 text-sm">Too good to be true opportunities</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Red flags:</strong> Registration fees, guaranteed high income, 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-emerald-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600 font-bold text-xl">
                4
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Prize/Lottery Scams</h3>
                <p className="text-slate-600 text-sm">You won something you didn't enter</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">How to spot it:</strong> You didn't enter any competition. 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-cyan-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-cyan-50 flex items-center justify-center text-cyan-600 font-bold text-xl">
                5
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">SASSA/NSFAS Scams</h3>
                <p className="text-slate-600 text-sm">Exploiting grant recipients</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Target:</strong> Vulnerable grant recipients. Scammers steal 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900">Bank OTP Harvesting</h3>
                <p className="text-slate-600 text-sm">Stealing your one-time pins</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Critical:</strong> The scammer initiates a transaction on YOUR account. 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-indigo-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 font-bold text-xl">
                7
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Romance Scams</h3>
                <p className="text-slate-600 text-sm">Love with a hidden agenda</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Pattern:</strong> Scammer builds emotional connection over weeks/months, 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-purple-50 flex items-center justify-center text-purple-600 font-bold text-xl">
                8
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Investment Scams</h3>
                <p className="text-slate-600 text-sm">Guaranteed returns that aren't</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Reality:</strong> Ponzi schemes, pyramid schemes, or outright theft. 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-pink-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-pink-50 flex items-center justify-center text-pink-600 font-bold text-xl">
                9
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Parcel Delivery Scam</h3>
                <p className="text-slate-600 text-sm">Fake Courier/Post Office messages</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Goal:</strong> Steal credit card details or banking info through fake payment page. 
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-rose-500">
            <div className="flex items-start gap-4 mb-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-rose-50 flex items-center justify-center text-rose-600 font-bold text-xl">
                10
              </div>
              <div>
                <h3 className="text-xl font-bold text-slate-900">Donation/Charity Scams</h3>
                <p className="text-slate-600 text-sm">Exploiting your generosity</p>
              </div>
            </div>
            <div className="bg-slate-50 p-4 rounded border border-slate-100 mb-4">
              <p className="text-slate-700 text-sm font-mono">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-slate-600">
                <strong className="text-slate-900">Tactic:</strong> Emotional manipulation using fake sob stories, 
      ...
      <section className="mb-12">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 border border-slate-100">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-bold text-indigo-600 mb-4">Security Settings</h3>
            ...
            <div>
              <h3 className="text-lg font-bold text-indigo-600 mb-4">Behavioral Rules</h3>
              <ul className="space-y-3 text-sm text-slate-600">
                <li className="flex gap-2">
      ...
      <section className="bg-white rounded-xl shadow-sm p-8 mb-12 border border-slate-100">
        <h2 className="text-2xl font-bold text-red-700 mb-4">⚠️ What to Do If You've Been Scammed</h2>
        <div className="space-y-4 text-slate-600">
          <div>
            <strong className="text-slate-900">1. Act Immediately:</strong>
          ...
          <div>
            <strong className="text-slate-900">2. Report to Authorities:</strong>
            <ul className="ml-6 mt-2 space-y-1 text-sm">
          ...
          <div>
            <strong className="text-slate-900">3. Document Everything:</strong>
            <ul className="ml-6 mt-2 space-y-1 text-sm">
      ...
      <section className="p-8 bg-gradient-to-br from-indigo-50 via-white to-purple-50 rounded-xl border border-slate-100 mt-12">
        ...
        <Link 
          href="/scan"
          className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl px-6 py-3 shadow-lg shadow-indigo-200 hover:shadow-indigo-300 transition-all hover:scale-105"
        >
          Scan Message Now →
        </Link>
      </section>
