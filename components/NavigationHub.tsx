...
const navItems = [
  ...
  },
  {
    category: 'Tools',
    links: [
      { href: '/scan', label: 'Scam Scanner (FREE)', icon: 'Scan' },
      { href: 'https://digital-footprint-scanner.vercel.app', label: 'Digital Footprint (R29)', icon: 'Footprint' },
      { href: '/trust-profile', label: 'Trust Profile (BETA)', icon: 'Trust' },
    ],
  },
  {
    category: 'Learn',
  ...
  },
  {
    category: 'Resources',
    links: [
      { href: '/phone-number-scams', label: 'Phone Number Scams', icon: 'Phone' },
